<template>
      ...
      <div class="main-content">
        <div v-if="activeTab === 'MasterList'">
          <div class="student-table">
            <SeniorHigh @view-student="handleViewStudent" />
          </div>
        </div>
        <div v-if="activeTab === 'Information'">
          <div class="student-table">
            <SeniorHighRecord v-if="selectedStudent" :student="selectedStudent" />
          </div>
        </div>
      </div>
    </main>
  ...
  import SeniorHighRecord from '../components/SeniorHighRecord.vue';
