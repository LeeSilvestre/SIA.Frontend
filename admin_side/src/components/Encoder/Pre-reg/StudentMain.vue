  ...
  <v-stepper v-model="step">
    <v-stepper-header>
      <v-stepper-item :value="1">
        <v-icon class="mr-2 fs-3" style="color: var(--dark)"
          >mdi-book-open</v-icon
        >
        <span class="card-title fw-bold fs-5" style="color: var(--dark)"
          >Guidlines</span
        >
      </v-stepper-item>
      ...
      <div class="guidelines">
        <div class="checkbox">
          <v-checkbox
            v-model="doAgree"
            v-if="step == 1"
            label="I understand the Guidelines above"
            value="True"
          ></v-checkbox>
        ...
        <div class="acceptbtn">
          ...
          <v-btn v-if="step == 2" class="bg-green large-button" @click="enroll"
            >Submit</v-btn
          >
        </div>
        <!-- ############################################################################# -->
