    ...
    <div>
      <v-stepper alt-labels :items="['Student Details', 'Personal Information', 'Academic Information']">
          ...
          <v-card flat>
            <v-card class="step-card">
              <v-card-text class="student-leftinfo">
                ...
                <div class="d-flex flex-column mb-3 faculty-details-item">
                  <strong class="text-padding">LRN:</strong> {{ student.student_lrn }}<br>
                </div>
                <div class="d-flex flex-column mb-3 faculty-details-item">
                  <strong class="text-padding">Grade Level:</strong> {{ student.grade_level }}<br>
                </div>
              </v-card-text>
            </v-card>
          </v-card>
        ...
        <template v-slot:item.3>
          <v-card flat>
            <!-- Add content for Academic Information -->
          </v-card>
        </template>
      </v-stepper>
    </div>
