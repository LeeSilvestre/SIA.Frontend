  ...
  <v-app>
    <v-stepper :items="['GUIDELINES', 'FORM']">
      <template v-slot:item.1>
        <v-card flat class="stepper-card">
          <v-card-title>
            ...
            <span class="card-title">PRE-REGISTRATION GUIDELINES</span>
          </v-card-title>
          <v-divider></v-divider>
          <v-card-text>
            <v-list lines="one">
            ...
            <v-alert type="info" class="mt-4">
              ...
              Classes for the school year 2024-2025 begin on July 29, 2024. Orientation for new students and parents will be held on August 1-2, 2024.
            </v-alert>
          </v-card-text>
        </v-card>
      </template>
      ...
      <template v-slot:item.2>
        <v-card flat>
          <v-card-title>
            <span class="card-title">PRE-REGISTRATION FORM</span>
          </v-card-title>
          <v-divider></v-divider>
          <v-card-text>
            <v-form v-model="valid">
              <v-container>
                ...
                <v-row>
                  <v-col cols="12" md="4">
                    <v-text-field v-model="student_lrn" :rules="studentLrnRules" :counter="10" label="Student LRN"></v-text-field>
                  </v-col>
                </v-row>
                <v-row>
                  <v-col cols="12" md="3">
                  ...
                  <v-col cols="12" md="3">
                    <v-text-field v-model="extension"  label="Extension" ></v-text-field>
                  </v-col>
                  <v-col cols="12" md="4">
                    <v-select v-model="sex" :items="['Male', 'Female']" label="Sex"  clearable required outlined></v-select>
                  </v-col>
                  <v-col cols="12" md="4">
                    <v-text-field v-model="birthdate" :rules="birthdateRules" label="Birthdate"></v-text-field>
                  </v-col>
                  <v-col cols="12" md="4">
                  ...
                  <v-col cols="12" md="4">
                    <v-text-field v-model="houseNumber" :rules="houseNumberRules" label="House Number"></v-text-field>
                  </v-col>
                  <v-col cols="12" md="4">
                    <v-text-field v-model="street" :rules="streetRules" label="Street"></v-text-field>
                  </v-col>
                  <v-col cols="12" md="4">
                    <v-text-field v-model="barangay" :rules="barangayRules" label="Barangay" ></v-text-field>
                  </v-col>
                  <v-col cols="12" md="4">
                    <v-text-field v-model="city" :rules="cityRules" label="City" ></v-text-field>
                  </v-col>
                  <v-col cols="12" md="4">
                    <v-text-field v-model="province" :rules="provinceRules" label="Province" ></v-text-field>
                  </v-col>
                  <v-col cols="12" md="4">
                    <v-text-field v-model="region" :rules="provinceRules" label="Region" ></v-text-field>
                  </v-col>
                  <v-col cols="12" md="4">
                    <v-text-field v-model="zipCode" :rules="zipCodeRules" label="Zip Code" ></v-text-field>
                  </v-col>
                </v-row>
                <div class="academic">
                ...
                <v-row>
                  <v-col cols="12" md="4">
                    <v-text-field v-model="contactNumber" :rules="contactNumberRules" label="Contact Number"
                      ></v-text-field>
                  </v-col>
                </v-row>
                <div class="academic">
                ...
                <v-row>
                  <v-col cols="12" md="4">
                    <v-select v-model="studentType" :items="['incoming', 'returning']" label="Student Type" clearable
                      outlined></v-select>
                  </v-col>
                  <v-col cols="12" md="4">
                    <v-select v-model="gradeLevel" :items="gradeLevels" label="Grade Level" clearable
                      outlined></v-select>
                  </v-col>
                  <v-col v-if="showStrand" cols="12" md="4">
                    <v-select v-model="strand" :items="['HUMSS', 'STEM', 'HE', 'ABM', 'GAS']" label="Strand" clearable
                      outlined></v-select>
                  </v-col>
                </v-row>
              </v-container>
...
export default {
  data: () => ({
    ...
    (value) => (value && value.length === 10) || "Student LRN must be 10 digits.",
  ],
    contactNumberRules: [
