...
<template>
    <div class="side-content-wrap">
        <div class="side-content-wrap">
            ...
            >
                <perfect-scrollbar>
                    <ul class="navigation-left">
                        ...
                        <!--StudentRecords-->
                        <router-link
                        to="/StudentRecords/studentrecords"
                        tag="li"
                        class="nav-item"
                    >
                        <div class="nav-item-hold">
                            <i class="i-Notepad-2 text-3xl"></i>
                            <p>Student <br> Records</p>
                        </div>
                    </router-link>
                    <!-- Dental Appointments -->
                   <router-link
                    to="/ClinicAppointments/clinic-appointments"
                    tag="li"
                    class="nav-item"
                >
                    <div class="nav-item-hold">
                        <i class="i-Nurse text-3xl"></i>
                        <p>Appointments</p>
                    </div>
                </router-link> 
                    <!-- Medicine -->
            ...
            >
                <div class="nav-item-hold">
                    <i class="i-First-Aid text-3xl"></i>
