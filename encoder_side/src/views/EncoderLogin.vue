                    ...
                    <v-col cols="12" md="7">
                      ...
                      <v-card-text class="mt-1">
                        ...
                        <h4 class="text-center pt-0 fs-6">
                          STUDENT PROFILLING - ENCODER PORTAL
                        </h4>
                        <v-form>
                          <v-text-field 
                            label="Email/ID"
                      ...
                      <div class="text-center pb-2 mx-md-auto">
                        <v-btn rectangle color="var(--dark)"> <router-link to="/studentprofile" style="color:white; text-decoration: none; width: auto; font-size: 15px; ">Sign in</router-link></v-btn>
                      </div>
